...
- (void)loadList
{
    ...
    NSString* url = [NSString stringWithFormat:@"%@event_info/%@/%@",delegate.heroURL,rewardID,delegate.userID];
...
- (void)submitJoin
{
    ...
    NSString* url = [NSString stringWithFormat:@"%@event_booking",delegate.heroURL];
