...
- (void)loadList
{
    ...
    NSString* url = [NSString stringWithFormat:@"http://spm-hero.thaidevelopers.com/api/redeem_info/%@/%@",rewardID,delegate.userID];
...
- (void)submitRedeem
{
    ...
    NSString* url = [NSString stringWithFormat:@"http://spm-hero.thaidevelopers.com/api/redeem"];
